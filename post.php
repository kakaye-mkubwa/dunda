...
<head>
    ...
    <meta name="title" content="<?=$rowDetails['post_title']?>">
    <meta name="description" content="<?=$rowDetails['post_desc']?>">
    <meta name="author" content="<?=$bloggerDetails['username']?>">

    <!-- Facebook   -->
    <meta property="og:site_name" content="Dunda Football">
    <meta property="og:title" content="<?=$rowDetails['post_title']?>" />
    <meta property="og:description" content="<?=$rowDetails['post_desc']?>" />
    <meta property="og:image" itemprop="image" content="<?=$rowDetails['image_url']?>">
    ...
    <meta property="twitter:title" content="<?=$rowDetails['post_title']?>">
    <meta property="twitter:description" content="<?=$rowDetails['post_desc']?>">
    <meta property="twitter:image" content="<?=$rowDetails['image_url']?>">
...
<?php include_once 'navbar.php';?>
    ...
    <header>
        <div class="col-lg-8 col-md-10 mx-auto pt-lg-3">
            <div class="post-heading pt-5 pt-5">
                <h1 itemprop="name"><?=$rowDetails['post_title']?></h1>
                <span class="meta text-muted">Posted by
                    <a href="#"><?=$bloggerDetails['username']?></a>
                    on <?=$month.' '.$day.', '.$year?>
                </span>
            </div>
        </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-8 col-md-10 mx-auto">
            ...
            ?>
            <img itemprop="image" class="img-fluid" src="<?=$rowDetails['image_url']?>" alt="<?=$rowDetails['post_desc']?>">
